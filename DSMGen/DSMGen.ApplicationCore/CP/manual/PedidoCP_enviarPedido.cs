...
/*PROTECTED REGION ID(usingDSMGen.ApplicationCore.CP.DSM1_Pedido_enviarPedido) ENABLED START*/
...
{
        /*PROTECTED REGION ID(DSMGen.ApplicationCore.CP.DSM1_Pedido_enviarPedido) ENABLED START*/
        ...
        try
        {
                ...
                foreach (LinPedidoEN linea in pedidoEN.LinPedido) {
                        ...
                        sombreroCEN.DecrementarStock (sombreroEN.IdSombrero, linea.Cantidad);
                }

                pedidoEN.Estado = DSMGen.ApplicationCore.Enumerated.DSM1.EstadoPedidoEnum.enviado;
