...
{
public partial class SombreroCP : GenericBasicCP
{
public SombreroCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public SombreroCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
