...
{
public partial class ItemCarritoCP : GenericBasicCP
{
public ItemCarritoCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public ItemCarritoCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
