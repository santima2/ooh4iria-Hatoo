...
{
public partial class LinPedidoCP : GenericBasicCP
{
public LinPedidoCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public LinPedidoCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
